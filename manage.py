...
def init():
    ...
    test_degree.courses.extend(
        [test_course_algebra, test_course_calculus, test_course_arhitecture, test_course_se, test_course_os,
         test_course_dbms, test_course_ai, test_course_networks])
    ...
    test_semester3.courses.extend([test_course_dbms, test_course_os])
    ...
    test_teaches2 = Teaches(teacher=test_teacher, semester=test_semester3, course=test_course_os)
